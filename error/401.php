...
<div class="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-950 via-gray-950 to-gray-950 flex items-center justify-center p-6">
    <div class="text-center space-y-6 max-w-lg">
        <div class="flex flex-col items-center justify-center space-y-4">
            <i class="fas fa-user-lock glitch-icon"></i>
            <div class="glitch-wrapper">
                <div class="glitch-number">401</div>
            </div>
        </div>
        <h1 class="text-3xl font-bold text-white">Unauthorized Access</h1>
        <p class="text-blue-300/80">You don't have permission to access this resource. Please log in with appropriate credentials.</p>
        <div class="pt-4">
